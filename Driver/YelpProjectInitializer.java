...
public class YelpProjectInitializer {
...

    {
        ...
        Review review3 = new Review("1", "User2", "restaurant2", "2", "is 2 gud 2");
        review3.setConnection(connection);
        review3.storeReview();
        review2.setConnection(connection);
        review2.storeReview();

        ReviewStore reviewStore = new ReviewStore(connection);//only have to create one instance of this
        System.out.println(reviewStore.getAllReviews("2"));//returns a List<String>
